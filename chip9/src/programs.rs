...
pub const BUILTIN_PROGRAMS: &[BuiltinProgram] = &[
    ...
    BuiltinProgram {
        name: "Hello World",
        category: Category::Demo,
        description: "Greets the world with the CHIP-9 alphabet font, written in C9.",
        controls: None,
        cycles_per_frame: DEFAULT_CYCLES_PER_FRAME,
        rom: include_bytes!("../roms/hello.ch8"),
    },
    BuiltinProgram {
        name: "Times Table",
        category: Category::Demo,
        description: "The seven times table, drawn with MUL, DIV and a recursive C9 function.",
        controls: None,
        cycles_per_frame: DEFAULT_CYCLES_PER_FRAME,
        rom: include_bytes!("../roms/times.ch8"),
    },
    BuiltinProgram {
        name: "Next",
        category: Category::Demo,
