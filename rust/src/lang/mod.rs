//! C8: a small C-like language that compiles to CHIP-8.
//!
//! The assembler in [`crate::asm`] made programs writable; this makes them
//! readable. A C8 program is compiled to assembly text and then handed to that
...
/// Compiles C8 source all the way to a ROM.
///
/// # Errors
///
...
/// Compiles C8 source as far as assembly text.
///
/// # Errors
///
